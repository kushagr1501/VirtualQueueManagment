                  ...
                  <div className="px-4 py-16 sm:px-6 text-center">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                      {searchQuery
                        ...
                        : "Start by adding customers to the queue"}
                    </p>
                    {!searchQuery && (
                      <div className="mt-6">
                        <button
                        ...
                        {filteredQueue.map((user, index) => (
                          ...
                          >
                            <td className="px-6 py-5 whitespace-nowrap">
                              <div className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-indigo-100 text-sm font-medium text-indigo-800">
                                {index + 1}
                              </div>
                            </td>
                            <td className="px-6 py-5 whitespace-nowrap">
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="bg-gray-50 px-6 py-4 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  type="button"
                  className="w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2.5 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm transition-all duration-200"
                  onClick={addToQueue}
                >
                  Add to Queue
                </button>
